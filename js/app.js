...
function renderSessions(container) {
    ...
    for (let s = 0; s < N; s++) {
        ...
        rrRows += `<tr class="rt-row">
            ...
            <td><span class="rt-team-chip rt-presenter">🎤 ${getTeamName(deptCode, pt)}</span></td>
            <td><span class="rt-team-chip rt-reviewer">🔍 ${getTeamName(deptCode, rt)}</span></td>
            <td><span class="rt-team-chip rt-feedback">💬 ${getTeamName(deptCode, ft)}</span></td>
